...
export default function PracticePage() {
  ...
  return (
    <>
      <section className="page-intro"><div className="page-wrap"><p className="section-label">Practice areas / six disciplines</p><h1 className="display">Experienced counsel for <em>important matters.</em></h1><p className="lede">From disputes and transactions to intellectual property and property work, our advice is built around the facts, the risk and the result that matters.</p></div></section>
