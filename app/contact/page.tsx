...
export default function ContactPage() {
  return <>
    ...
    <section className="paper-section appointment-section"><div className="page-wrap appointment-layout"><div className="appointment-copy"><p className="section-label">Online appointment requests</p><h2>Make space for the right conversation.</h2><p>Choose a preferred date and time. The Lex Interface team will review availability and confirm the appointment directly.</p><div className="facts"><div className="fact"><strong>01</strong><span>Request a time</span></div><div className="fact"><strong>02</strong><span>Team confirms</span></div></div></div><AppointmentForm /></div></section>
  </>;
}
